...
CREATE TABLE MEM_UNIQUE3 (
    MEM_NO NUMBER NOT NULL CONSTRAINT NOUNIQUE UNIQUE,
    MEM_ID VARCHAR2(20) NOT NULL,
    MEM_PW VARCHAR2(20) NOT NULL,
    MEM_NAME VARCHAR2(20),
    GENDER CHAR(3),
...
INSERT INTO MEM_UNIQUE3 VALUES(2, 'uid2','upw2', '이길동', '남');
INSERT INTO MEM_UNIQUE3 VALUES(3, 'uid3','upw2', '이임상', 'M');
INSERT INTO MEM_UNIQUE3 VALUES(4, 'uid3','upw2', '이임상', 'T');
-- 성별 : 남, 여
