...
SELECT EMP_NAME, SALARY*12, SALARY*12+SALARY*BONUS, (SALARY - (SALARY * 0.03))*12 + SALARY*BONUS
FROM EMPLOYEE;
...
SELECT EMP_NAME, SALARY, (SALARY - (SALARY * 0.03))*12 + SALARY*BONUS, HIRE_DATE
FROM EMPLOYEE
WHERE (SALARY - (SALARY * 0.03))*12 + SALARY*BONUS >= 50000000;
